...
const COMPLAINER_PROMPTS_LOGN = [
  ...
  { id: 'familie2', category: 'familie', tier: 2, text: 'Du har løjet om at have ringet til din far i weekenden, som du lovede. Du forklarer dig til din søster, som lige har talt med ham. Hvad siger du?' },
  { id: 'familie3', category: 'familie', tier: 3, text: 'Du har løjet i årevis om hvorfor du og en bestemt slægtning ikke taler sammen mere. Du bliver konfronteret af en yngre fætter, som endelig spørger direkte. Hvad siger du?' },
  ...
  { id: 'arbejde2', category: 'arbejde', tier: 1, text: 'Du har løjet om hvorfor du kom for sent til et møde. Du forklarer dig til en kollega, som ventede udenfor mødelokalet. Hvad siger du?' },
  { id: 'arbejde3', category: 'arbejde', tier: 3, text: 'Du har løjet på dit CV om en kompetence du reelt ikke har. Du bliver bedt om at demonstrere den, foran en kollega der stoler blindt på dig. Hvad siger du?' },
  ...
  { id: 'fremmed2', category: 'fremmed', tier: 2, text: 'Du har løjet om at have mistet en kvittering for at få byttet en vare uden problemer. Du forklarer dig til en ekspedient, som lige har fundet den i systemet alligevel. Hvad siger du?' },
  { id: 'fremmed3', category: 'fremmed', tier: 3, text: 'Du har løjet konsekvent om dit erhverv over for en taxachauffør hele turen. Chaufføren nævner tilfældigt noget der modsiger hele historien. Hvad siger du?' },
